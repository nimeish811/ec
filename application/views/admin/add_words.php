				...
				<div class="section-body">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							$attributes = array('action' => base_url().'admin_master/add_words','onsubmit'=>'return checkvalid()' );
							echo form_open_multipart('admin_master/add_words', $attributes);
							?>
							<?php 
										...
										<div class="col-md-5 col-sm-6">
											...
											<?php foreach($source_lang as $key){?>
												<div class="col-md-12 mrgt10">
													...
													<input type="text" name="word_<?= $key['language_code']; ?>" class="form-control" placeholder="Word Name in <?= $key['language_name']; ?>" value="<?php echo set_value('word_'.$key['language_code']);?>"  >
