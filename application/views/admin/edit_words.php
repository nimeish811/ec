				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							...
							<a href="<?php echo base_url(); ?>admin_master/words_list" class="btn btn-primary btn-sm btn-raised pull-right">Back To List</a>
						</ol>
...
$attributes = array('action' => base_url().'admin_master/edit_words/'.$edit_data[0]['word_id'],'onsubmit'=>'return checkvalid()');
echo form_open_multipart('admin_master/edit_words/'.$edit_data[0]['word_id'], $attributes);
?>
<?php 
...
<?php } ?>
						...
						<?php } ?>
												...
												<div class="col-md-12 mrgt5">
													...
													<img src="<?php echo base_url(); ?>uploads/words/<?php echo $edit_data[0]['category_id']; ?>/<?php echo $edit_data[0]['subcategory_id']; ?>/<?php echo$edit_data[0]['image_file']; ?>" class="mrgt10 img-responsive" width="60px" onerror="this.onerror=null;this.src='<?php echo base_url(); ?>assets/thumb_image_not_available.png';"/>
												</div>
											...
											<div class="col-md-5 col-sm-6">
												...
												<div class="col-md-12 mrgt10">
													...
													<input type="text" name="word_<?= $key['language_code']; ?>" class="form-control" value="<?php echo $edit_data[0][$key['field_name']];?>" placeholder="Word Name in <?= $key['language_name']; ?>" value="<?php echo set_value('word_'.$key['language_code']);?>"  >
