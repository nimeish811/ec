			...
			<section>
				<div class="section-header">
					<ol class="breadcrumb">
						...
						<li class="active">Add Pharses</li>
				...
				<div class="section-body">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							$attributes = array('action' => base_url().'admin_master/add_phrases','onsubmit'=>'return checkvalid()' );
							echo form_open_multipart('admin_master/add_phrases', $attributes);
							?>
							<?php 
									...
									<div class="row">
										...
										<div class="col-md-5 col-sm-6">
											...
											<?php foreach($source_lang as $key){?>
												<div class="col-md-12 mrgt10">
													<label>Phrase In <?= $key['language_name'];?></label>
													<input type="text" name="phrase_<?= $key['language_code']; ?>" class="form-control" placeholder="Phrase in <?= $key['language_name']; ?>" value="<?php echo set_value('word_'.$key['language_code']);?>"  >
