			...
			<div id="content">
				...
				<section>
					...
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="#">Home</a></li>
							<li class="active">Bulk Audio Upload</li>
...
?>
<form action="<?php echo base_url(); ?>admin_master/upload_word_audio" 
...
<?php } ?>
									<div class="form-group">
										<div class="row">
											...
											<div class="col-md-12 mrgt10">
												...
												<option <?php if($mode==$key['id']) { echo "selected"; } ?> value="<?php echo $key['id'];?>"><?php echo $key['mode_name'];?> </option>
												<?php } ?>
													</select>
											...
											<div class="col-md-12 mrgt10">
													...
													<select class="chosen-select" id="category" name="category">
														...
														<?php foreach($category as $key){ ?>
															<option  <?php if($cateid==$key['exercise_mode_category_id']) { echo "selected"; } ?> value="<?php echo $key['exercise_mode_category_id'];?>"><?php echo ucfirst($key['category_name_in_en']);?> </option>
														<?php } ?>
													</select>
											...
											<div class="col-md-12 mrgt10">
													...
													<select  id="subcate" name="subcategory" class="chosen-select">
						...
						<?php } ?>
												...
												<div class="clearfix"></div>
												<label class="col-md-12 mrgt10">Audio </label>
...
//console.log($(this).get(0).files.length); return false;
	...
	if (parseInt($fileUpload.get(0).files.length)>20){
       ...
       //  alert("You can only upload a maximum of 2 files");
         $("#file_error").text("You can only upload a maximum of 20 files");
         Validat = 0;
	}
