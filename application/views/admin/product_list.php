						...
						<div class="card">
							<div class="card-body">
								...
								<form action="<?php echo base_url(); ?>admin_master/delete_all_category" method="post" onsubmit="return confirm_delete();">
									<div class="row">
										<h4 class="col-md-2 col-sm-3 mrgt15">Product List</h4>
										<div class="col-md-10 col-sm-9 mrgt10">
											<a href="<?php echo base_url(); ?>admin_master/add_product" class="btn btn-primary btn-sm btn-raised pull-right ">Add New</a>
											...
											<div class="table-responsive no-margin">
												<table id="example" class="table order-column hover dataTable no-footer">
													...
													<tbody id="tbody">
														...
														<tr>
															<td><?php echo $ctn; ?></td>
															<td><img src="<?php echo base_url(); ?>uploads/<?php echo $key['product_image']; ?>" class="img-responsive" width="60px" onerror="this.onerror=null;this.src='<?php echo base_url(); ?>assets/thumb_image_not_available.png';"/></td>
															<td><?php echo ucfirst($key['product_name']); ?></td>
															<td><a href="<?php echo base_url();?>admin_master/edit_product/<?php echo $key['id']; ?>"><i class="fa fa-pencil action"></i> </a>  <a onclick="return confirm('Are you sure?');" href="<?php echo base_url();?>admin_master/delete_product/<?php echo $key['id']; ?>"> <i class="fa fa-trash-o action"></i> </a></td>
